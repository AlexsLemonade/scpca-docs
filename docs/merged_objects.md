...
| `is_infercnv_reference`  | Whether the cell would be considered part of the reference normal cells for `inferCNV` inference. This column is present if consensus cell types were assigned, regardless of whether CNV inference was performed |
