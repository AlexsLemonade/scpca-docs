...
This process was repeated across a wide range of `k` values (number of clusters), and a set of unbiased metrics were used to determine the optimal value of `k`, corresponding to the final number of metaprograms. 
...
The objects available on the Portal contain the scores for all cells across all final metaprograms. 
